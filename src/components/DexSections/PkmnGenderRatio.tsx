  ...
  return (
    <div id="gender-ratio">
      ...
      <div className="progress" style={{ height: '1.5rem' }}>
        {genderRate !== -1 ? (
          <>
            <div className="progress-bar" role="progressbar" style={{ width: `${malePercent}%` }}>
              <strong>
                {`${malePercent}%`}
                {' '}
                (M)
            ...
            <div className="progress-bar bg-danger" role="progressbar" style={{ width: `${femalePercent}%` }}>
              <strong>
                {`${femalePercent}%`}
                {' '}
                (F)
